...
const CategoryCreate = ({ onSuccess, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError('فشل في إنشاء الفئة. تحقق من البيانات أو نوع الصورة.');
        } finally {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="cat-form-group">
                        ...
                        <input
                            ...
                            id="image"
                            name="image"
                            onChange={handleChange} // لا تضع value هنا
                        />
                    </div>
                    ...
                    <div className="cat-form-actions">
                        ...
                        >
                            {isSubmitting ? 'جارٍ الإنشاء...' : 'إنشاء الفئة'}
                        </button>
                    </div>
                </form>
            </div>
